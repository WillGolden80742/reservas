        ...
        if (itemId) {
            ...
            if (index !== -1) {
                items[index] = {
                    ...
                    whatsappLink: `https://wa.me/${phoneForWhatsapp}`
                };
                openModal(DOM.alertModalOverlay, 'Sucesso!', `${type === 'reservation' ? 'Reserva' : 'Pedido'} atualizado com sucesso!`, 'success');
            }
        } else {
            const newItem = {
                id: Date.now(),
            ...
            items.push(newItem);
            openModal(DOM.alertModalOverlay, 'Sucesso!', `${type === 'reservation' ? 'Reserva' : 'Pedido'} adicionado com sucesso!`, 'success');
        }
